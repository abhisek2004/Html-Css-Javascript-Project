...
function init() {
  ...
  prevArrow?.addEventListener("click", () => queueStep("prev"));
  nextArrow?.addEventListener("click", () => queueStep("next"));
...
async function loop() {
  await animate(".indicator", 0.5, { x: 0 });
  await animate(".indicator", 0.4, { x: window.innerWidth, delay: 0.3 });
